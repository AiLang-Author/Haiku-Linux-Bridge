...
**Share this with testers:** [`docs/STATUS.md`](docs/STATUS.md) — what works, what to run, how to file a useful bug. Latest wrap: [`docs/STANDUP_DAY28.md`](docs/STANDUP_DAY28.md).
...
| busybox `sh -c 'echo'` | **Works** — prints `SHOK`. Pipe (`echo HI \| cat`) forks echo then Kill Thread (shared Linux stack). See Day 28. |
