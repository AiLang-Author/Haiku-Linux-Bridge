...
**Share this with testers:** [`docs/STATUS.md`](docs/STATUS.md) — what works, what to run, how to file a useful bug. Latest wrap: [`docs/STANDUP_DAY27.md`](docs/STANDUP_DAY27.md).
...
| busybox `sh -c 'echo'` | **Works** — prints `SHOK`. Pipe (`echo HI \| cat`) stamps then dies. See Day 27. |
