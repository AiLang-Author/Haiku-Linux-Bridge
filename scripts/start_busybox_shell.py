#!/usr/bin/env python3
# Start Interactive BusyBox Shell inside Haiku Terminal
...
if __name__ == "__main__":
    ...
    print("[+] Launching interactive BusyBox Linux Shell (ash)...")
    type_text("cd /boot/home\n")
    time.sleep(0.5)

    type_text("./sys_compat_run ./busybox sh\n")
    time.sleep(1.0)

    print("[+] Interactive BusyBox Linux Shell Launched!")
