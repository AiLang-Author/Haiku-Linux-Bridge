#!/usr/bin/env python3
# Ensure GDB is installed and run GDB backtrace capture in Haiku
...
if __name__ == "__main__":
    ...
    print("[+] Running debugger capture in Haiku...")
    type_text("cd /boot/home\n")
    time.sleep(0.5)

    type_text("pkgman install -y gdb\n")
    time.sleep(4.0)
    ...
    print("[+] GDB installation & backtrace capture completed.")
