#!/usr/bin/env python3
# Compile and Deploy TLS-enabled sys_compat_run inside Haiku
...
if __name__ == "__main__":
    ...
    print("[+] Downloading TLS-enabled sys_compat_run.c...")
    ...
    print("[+] Compiling sys_compat_run natively in Haiku...")
    ...
    print("[+] Launching BusyBox via TLS-enabled sys_compat_run...")
    type_text("./sys_compat_run ./busybox\n")
    time.sleep(2.0)

    print("[+] TLS deployment sequence completed.")
