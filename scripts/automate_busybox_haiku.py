#!/usr/bin/env python3
# Autonomous Haiku BusyBox Linux CLI Automation Test Script
...
if __name__ == "__main__":
    ...
    print("[+] Copying BusyBox 64-bit Linux binary to Haiku home...")
    type_text("cp /payload/tests/busybox /boot/home/\n")
    time.sleep(0.5)

    type_text("chmod +x /boot/home/busybox\n")
    time.sleep(0.5)

    print("[+] Executing BusyBox CLI applets inside Haiku...")
    type_text("/boot/home/busybox echo '==========================================='\n")
    time.sleep(0.5)

    type_text("/boot/home/busybox echo '  BusyBox Linux CLI running on Haiku OS!  '\n")
    time.sleep(0.5)
    ...
    type_text("/boot/home/busybox cat /proc/meminfo\n")
    time.sleep(1.0)

    type_text("/boot/home/busybox cat /proc/cpuinfo\n")
    time.sleep(1.0)

    type_text("/boot/home/busybox date\n")
    time.sleep(1.0)

    print("[+] BusyBox Execution Test Sequence Completed.")
