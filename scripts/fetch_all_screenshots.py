#!/usr/bin/env python3
# Upload all saved PNG screenshots from Haiku OS to Host Linux
...
if __name__ == "__main__":
    ...
    print("[+] Uploading all saved screenshots to host upload server (10.0.2.2:8082)...")
    type_text("for f in /boot/home/*.png /boot/home/Desktop/*.png; do curl -X POST --data-binary @\"$f\" http://10.0.2.2:8082/$(basename \"$f\"); done\n")
    time.sleep(2.5)

    print("[+] Screenshot upload loop executed.")
