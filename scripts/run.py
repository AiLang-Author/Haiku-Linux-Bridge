#!/usr/bin/env python3
# Standard Reusable QEMU Haiku Automation & Screenshot Capture Script
...
if __name__ == "__main__":
    ...
    print("[+] Capturing screenshot.png inside Haiku...")
    type_text("screenshot -f /boot/home/screenshot.png\n")
    time.sleep(1.0)

    print("[+] Uploading screenshot.png to host upload server (10.0.2.2:8082)...")
    type_text("curl -X POST --data-binary @/boot/home/screenshot.png http://10.0.2.2:8082/screenshot.png\n")
    time.sleep(1.5)
