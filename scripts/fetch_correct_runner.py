#!/usr/bin/env python3
# Fetch exact sys_compat_run (with underscores) and launch BusyBox inside Haiku
...
if __name__ == "__main__":
    ...
    print("[+] Fetching exact sys_compat_run binary (with underscores)...")
    ...
    print("[+] Fetch & Execution sequence completed successfully.")
