...
#define AT_EXECFN 31
    ...
    *(--sp) = (uint64_t)linux_argc;
     ...
     */
/* ailang.x usage ~56MB ANON; tiny compile ~629MB; self-compile
	 * ailang_cli.ailang ~1.77GB RSS. Carve munmap is a no-op. */
#define SYS_COMPAT_ARENA_SIZE (2048u * 1024u * 1024u)
